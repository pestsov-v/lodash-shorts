...
- [Lodash - ключевые особенности](#lodash---ключевые-особенности)
  ...
  - [Продвинутые функции](#продвинутые-функции)
    ...
    - [Иммутабельное обновление данных](#иммутабельное-обновление-данных)
...
_.assign - аналог JavaScript, но поддерживающий все версии браузера.

Файл с примерами [_.update_data](advanced_functions/update_data.js)
